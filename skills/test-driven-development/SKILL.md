...
description: >
  TDD 红绿重构:先写失败的测试,再写最小实现转绿,最后重构。
whenToUse: >
  写新功能或修 bug 且项目有测试基建时。
version: 0.0.1
---

# Test-Driven Development (TDD)

> **随包说明**:本技能随 `dsh-plugin-dev-workflow` 一起发布(包内 `skills/test-driven-development/`),
...
```python
# RED — verify failure
pwsh("pytest tests/test_feature.py::test_name -v")
