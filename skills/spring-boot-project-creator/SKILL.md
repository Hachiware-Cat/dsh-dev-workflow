...
description: >
  从 Spring Initializr 起 Spring Boot 3.x/4.x 工程,并配好分层或 DDD 包结构、JPA 与 SpringDoc。
whenToUse: >
  Java 项目要从零起一个 Spring Boot 工程时。
version: 0.0.1
---

# Spring Boot Project Creator

> **随包说明**:本技能随 `dsh-plugin-dev-workflow` 一起发布(包内 `skills/spring-boot-project-creator/`),
