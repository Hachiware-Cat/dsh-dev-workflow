...
description: >
  Spring Boot 3 CRUD 落地范式:领域聚合、JPA 仓库、DTO、Controller,附可跑的生成脚本与模板。
whenToUse: >
  按 feature 组织写增删改查接口时(Java/Spring 后端)。
version: 0.0.1
---

# Spring Boot CRUD Patterns

> **随包说明**:本技能随 `dsh-plugin-dev-workflow` 一起发布(包内 `skills/spring-boot-crud-patterns/`),
