...
description: >
  提交前评审:安全扫描、质量门禁,并给出可直接粘贴的修复建议。
whenToUse: >
  ④ 质检做代码评审时;或开发自审后再交质检前。
version: 0.0.1
---

# Pre-Commit Code Verification

> **随包说明**:本技能随 `dsh-plugin-dev-workflow` 一起发布(包内 `skills/requesting-code-review/`),
...
Call `subagent` directly — it is NOT available inside execute_code or scripts.
